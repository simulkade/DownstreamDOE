...
methods of experimental design that comes up during their discussions with her
colleagues and how to analyze data specially when the number of experiments are
limited. You can imagine that a lot of these discussions become speculative until
...
we can expect in real world. The uncertainty we can mimic by adding noise to the
virtual ``measurements''. The measurements are another story! We rarely have any
...
to solve it with method of lines but the solver failed (on second thought, I should
have used a solver suited for stiff ODEs). I therefore switched to our PyFVTool
...
This part I made for a light reading during a train ride or a fast track method to
familiarize the potential users to these fascinating concepts. Here we are now! I
