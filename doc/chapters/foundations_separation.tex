...
small teaching module (\code{downstream\_doe.foundations.separation\_demo}).
...
(Figure~\ref{fig:sep-train}). This monograph lives almost entirely downstream.
...
(fermentation/cell culture) makes the molecule; \emph{downstream}---the subject of
this book---clarifies, captures, polishes, and formulates it. Each box is a
